...
# содержащий элементы: оклад и премия, например, {"wage": wage, "bonus": bonus}. Создать
...
class Position(Worker):
    ...
    def get_total_income(self):
        print(f'Доход сотрудника равен {self._income["wage"] + self._income["bonus"]}')


Worker_1 = Position('Юрий', 'Горобец', 'Разработчик', 80000, 20000)
print(Worker_1.name)
